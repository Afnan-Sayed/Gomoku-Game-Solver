...
class GomokuGame:
    ...
    def start_game(self):
        ...
        game_mode = input(
            "Choose game mode:\n1. Human vs. AI Minimax\n2. Human vs. AI Alpha_Beta\n3. AI svs. AI\nEnter your choice (1 or 2 or 3): ")

        if game_mode == "1":
            self.play_human_vs_ai_minimax()
        elif game_mode == "2":
            self.play_human_vs_ai_alphaBeta()
        elif game_mode == "3":
            self.play_ai_vs_ai()
        else:
            print("Invalid choice, please enter 1 or 2.")

    def play_human_vs_ai_minimax(self):
        # Play Human vs. AI minimax
    ...
    def play_human_vs_ai_alphaBeta(self):
        # Play Human vs. AI alphabeta
        while not self.game_over:
            self.board.display_board()
            if self.current_player == 1:  # Human's turn
                self.human_move()
